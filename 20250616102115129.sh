...
sed -i "s|network controller UI by|网络控制器用户界面|g" ztncui/src/views/index.pug
...
find ztncui -type f -exec sed -i 's/Key Networks/DSLab NetWorks/g' {} +
find ztncui -type f -exec sed -i 's/ZeroTier/云藏项目部/g' {} +                                                                                        
find ztncui -type f -exec sed -i 's|https://key-networks.com|http://dslab.lzu.edu.cn|g' {} +                                                                                        
find ztncui -type f -exec sed -i 's|https://zerotier.com|http://www.yongzin.com|g' {} +               
find ztncui -type f -exec sed -i 's|ZTNCUI|后台管理|g' {} +               
find ztncui -type f -exec sed -i 's|ztncui|后台管理|g' {} +               